...
> Neat check tls version support for a domain

[![PyPI version](https://badge.fury.io/py/neat-tls-version.svg)](https://pypi.org/project/neat-tls-version/)
...
```bash
pip install neat-tls-version
```

## Quick Start

```python
from neat_tls_version import version
...
from neat_tls_version import batch
